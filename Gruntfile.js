...
module.exports = function (grunt) {
    ...
    taskConfig = {
        ...
        copy: {
            ...
            // copies all assets from build dir to compile dir
            compile_assets: {
                files: [
                    {
                        src: ['**'],
                    ...
                    {
                        src: ['**'],
                        dest: '<%= compile_dir %>/translations',
                        cwd: '<%= build_dir %>/translations',
                        expand: true
                    }
                ]
            }
        ...
        concat: {
            ...
            compile_css: {
                ...
                dest: '<%= compile_dir %>/assets/<%= pkg.name %>-vendor-<%= pkg.version %>.css'
            }
        },
    ...
    grunt.registerTask('compile', [
        'copy:compile_assets', 'ngAnnotate', 'concat:compile_js', 'concat:compile_css', 'index:compile'
    ]);
